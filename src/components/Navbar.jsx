...
const Navbar = () => {
  ...
  return (
    <div className="flex items-center justify-between px-12 py-4 m-3 text-sm border-b">
      <img onClick={()=> navigate("/")} className="w-40" src={assets.logo} alt="web-logo" />
      <ul className="flex items-start justify-start gap-5 text-black">
        <NavLink to="/">
          <li>HOME</li>
      ...
      <div>
        {token ? (
            <div className="flex items-center gap-2 group relative">
                <img className="w-9 rounded-full" src={assets.profile_pic} alt="user-profile"/> 
